...
a persistence unit "EmployeeManagmentPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EmployeeManagment/pom.xml":
...
artifact ("EmployeeManagment.war") is already built. You can build
